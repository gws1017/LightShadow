...
{
public:
	CTerrainPlayer(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, void* pContext = NULL, CBulletObject** pBullet=NULL ,int nMeshes = 1);
	...
	void SetCameraPos(XMFLOAT3& xmf3Position);
	void SetPlayerPos(const XMFLOAT3& xmf3Positionm, AXIS axis);
